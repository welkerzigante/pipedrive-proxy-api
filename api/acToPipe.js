// CÓDIGO COMPLETO PARA DEBUG FINAL
...
export default async function handler(req, res) {
    ...
    // ... (resto do código inicial permanece o mesmo) ...
    ...
    try {
        ...
        console.log("DADOS COMPLETOS DO DEAL RECEBIDOS DO PIPEDRIVE:", JSON.stringify(dealData, null, 2));
